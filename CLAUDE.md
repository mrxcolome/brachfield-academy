...
- Siguiente: FASE 8 (Courses) — consumir cursos/lecciones desde Payload en el área privada (sustituir catálogo estático), player Cloudflare Stream, progreso. Requiere cuenta Cloudflare (Stream + R2).
