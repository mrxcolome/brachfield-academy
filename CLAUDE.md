...
- Siguiente: FASE 11 (Tools — descargas con URL firmada + DownloadLog; necesita Cloudflare R2). Cloudflare (Stream+R2) desbloquea el player y los uploads persistentes.
