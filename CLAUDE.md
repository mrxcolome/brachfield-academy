...
- Siguiente: FASE 16 (Testing E2E Playwright de los 9 flujos críticos), 17 (Performance), 18 (Production). CAMBIO PEDIDO por el propietario (2026-08-11): eliminar "nivel" de los CURSOS (colección, admin, UI, seed, búsqueda, personalización) — la formación no va por niveles; los contenidos SÍ mantienen nivel.
