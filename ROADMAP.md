...
| **11 — Tools**            | Plantillas/checklists/scripts, preview, descarga con URL firmada + DownloadLog                                                                                                                                                       | ✅ (verificar player y R2 en producción)                    |
| **12 — Events**           | Eventos, reserva/cancelación, recordatorios por email, replays                                                                                                                                                                       | ✅ (adelantada; la 11 espera a Cloudflare)                  |
