...
| --- | --- | --- |
| **0 — Discovery** | TECHNICAL_PLAN, CLAUDE.md, ROADMAP, DECISIONS | ✅ Entregada, en revisión |
...
| **3 — Auth + Billing** | Signup/login/reset/verificación, Stripe Checkout, webhooks idempotentes, guards de membership, página billing + Customer Portal | ⬜ |
...
| **7 — Content Engine** | Payload CMS: colecciones content/categorías/tags/media, workflow DRAFT→PUBLISHED, R2, publicación | ⬜ |
| **8 — Courses** | Cursos/módulos/lecciones, player Cloudflare Stream (velocidades, subtítulos, capítulos, PiP), progreso con throttle, continuar donde lo dejaste, transcript clicable | ⬜ |
| **9 — Library** | Explorar (descubrimiento editorial) + Biblioteca (consulta estructurada), categorías, filtros, relacionados | ⬜ |
