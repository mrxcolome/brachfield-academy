...
| **3 — Auth + Billing**    | Signup/login/reset/verificación, Stripe Checkout, webhooks idempotentes, guards de membership, página billing + Customer Portal                                                                                                      | ✅ código (Stripe test pendiente de cuenta) |
