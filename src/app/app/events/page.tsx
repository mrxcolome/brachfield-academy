...
export const metadata = { title: 'Sesiones en directo' }

/** Las citas en vivo con Pere (10/09: recuperan página propia al quedar
 *  Actualidad solo para noticias): próximos con reserva y replays. */
export default async function LiveSessionsPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <h1 className="mb-1 text-2xl font-bold">Sesiones en directo</h1>
      <p className="mb-7 text-sm text-muted">
        Las citas en vivo con Pere. Reserva tu plaza y te recordaremos la cita por email el día
        antes.
      </p>

      <section className="mb-10">
        <h2 className="mb-3 text-[13px] font-semibold text-ink-2">Próximas</h2>
        {upcoming.length === 0 ? (
          <EmptyState
            icon="◉"
            title="No hay directos programados ahora mismo"
