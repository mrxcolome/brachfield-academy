// Logo oficial de Brachfield Academy (2026-08): cuatro cuadrados —el azul
// girado— y wordmark "Brachfield" (tinta) + "Academy" (azul).
...
export function BrandLogo({
  ...
  return (
    <span className={cn('inline-flex items-center gap-2.5', className)}>
      ...
      >
        <span className="text-ink">Brachfield</span>{' '}
        <span style={{ color: LOGO_NAVY }}>Academy</span>
      </span>
    </span>
  )
}
